        ...
        <div class="max-w-md w-full glass-card rounded-2xl p-8 animate-entrance">
            ...
            <div class="text-center mb-6">
                <img src="{{ asset('images/educaweb-logo.png') }}" alt="EducaWeb"
                    class="w-24 mx-auto mb-4 logo-animation">
                <h2
                    class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 mb-1">
                    EducaWeb</h2>
                <p class="text-gray-500 text-sm">Plataforma educativa digital</p>
            </div>

            <!-- Línea decorativa -->
            <div class="relative flex py-2 items-center mb-6">
                <div class="flex-grow border-t border-gray-200"></div>
                <span class="flex-shrink mx-3 text-gray-400 text-sm">Iniciar Sesión</span>
                <div class="flex-grow border-t border-gray-200"></div>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="flex items-center justify-between text-sm">
                    <div class="flex items-center">
                        ...
                        <label for="remember_me" class="ml-2 text-gray-600">Recordarme</label>
                    </div>
