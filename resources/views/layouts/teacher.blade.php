...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <!-- Header/Navbar Superior - Ahora con estilo oscuro -->
        ...
        <div class="flex justify-between items-center px-4 h-full">
            ...
            <a href="{{ route('profile.show') }}"
                ...
                <div class="hidden md:block">
                    ...
                    <p class="text-xs text-gray-400 leading-tight capitalize">PROFESOR</p>
                </div>
            </a>
    ...
    <div class="flex pt-16 h-screen">
        <!-- Sidebar - Ahora con estilo oscuro -->
        <aside id="sidebar"
            ...
            <nav class="p-4 text-sm text-gray-700 h-full flex flex-col">
                <div class="mb-6 px-2">
                    <p class="text-xs uppercase font-semibold text-gray-400 tracking-wider">Panel del profesor</p>
                </div>

                <ul class="space-y-1 flex-1">
                    <li>
                        <a href="{{ route('teacher.dashboard') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg transition
                            {{ request()->routeIs('teacher.dashboard') ? 'bg-blue-50' : '' }}">
                            <i
                                class="bi bi-speedometer2 text-lg {{ request()->routeIs('teacher.dashboard') ? 'text-blue-400' : 'text-gray-400' }}"></i>
                            Dashboard
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('teacher.subjects') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg transition
                            {{ request()->routeIs('teacher.subjects*') ? 'bg-blue-50' : '' }}">
                            <i
                                class="bi bi-journals text-lg {{ request()->routeIs('teacher.subjects*') ? 'text-blue-400' : 'text-gray-400' }}"></i>
                            Mis Asignaturas
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('teacher.students') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg transition
                            {{ request()->routeIs('teacher.students*') ? 'bg-blue-50' : '' }}">
                            <i
                                class="bi bi-people-fill text-lg {{ request()->routeIs('teacher.students*') ? 'text-blue-400' : 'text-gray-400' }}"></i>
                            Estudiantes
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('teacher.attendance') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg transition
                            {{ request()->routeIs('teacher.attendance*') ? 'bg-blue-50' : '' }}">
                            <i
                                class="bi bi-calendar-check text-lg {{ request()->routeIs('teacher.attendance*') ? 'text-blue-400' : 'text-gray-400' }}"></i>
                            Asistencia
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('teacher.grades') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg transition
                            {{ request()->routeIs('teacher.grades*') ? 'bg-blue-50' : '' }}">
                            <i
                                class="bi bi-clipboard2-data text-lg {{ request()->routeIs('teacher.grades*') ? 'text-blue-400' : 'text-gray-400' }}"></i>
                            Calificaciones
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('teacher.tasks') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg transition
                            {{ request()->routeIs('teacher.tasks*') ? 'bg-blue-50' : '' }}">
                            <i
                                class="bi bi-card-checklist text-lg {{ request()->routeIs('teacher.tasks*') ? 'text-blue-400' : 'text-gray-400' }}"></i>
                            Tareas
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('teacher.chat.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg transition
                            {{ request()->routeIs('teacher.chat') ? 'bg-blue-50' : '' }}">
                            <i
                                class="bi bi-chat-dots text-lg {{ request()->routeIs('teacher.chat') ? 'text-blue-400' : 'text-gray-400' }}"></i>
                            Chat
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('teacher.resources') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg transition
                            {{ request()->routeIs('teacher.resources*') ? 'bg-blue-50' : '' }}">
                            <i
                                class="bi bi-archive text-lg {{ request()->routeIs('teacher.resources*') ? 'text-blue-400' : 'text-gray-400' }}"></i>
                            Recursos
                        </a>
                    </li>
                </ul>
