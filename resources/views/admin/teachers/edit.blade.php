...
@section('dashboard-content')
    <div class="max-w-xl mx-auto bg-white p-8 shadow-md rounded-lg">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Editar Profesor</h2>
        ...
        <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST" class="space-y-5">
            @csrf
            @method('PUT')

            <div>
                <label for="user_id" class="block font-medium text-gray-700 mb-1">Usuario asignado</label>
            ...
            <div>
                <label class="block font-medium text-gray-700 mb-1">Código del Profesor</label>
