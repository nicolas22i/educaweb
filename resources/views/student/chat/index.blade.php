...
<div class="mb-8">
    <p class="text-gray-600">Consulta y gestiona tus conversaciones con profesores</p>
</div>
...
<div class="col-span-full flex flex-col items-center justify-center p-10 bg-gray-50 rounded-xl border border-gray-200">
    ...
    <p class="text-gray-500 text-center">Tus conversaciones con profesores aparecerán aquí.</p>
    <a href="{{ route('student.chat.create') }}" class="mt-6 inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-2.5 rounded-lg transition-colors">
...
<div class="flex flex-wrap gap-4 mb-8">
    <div>
        <a href="{{ route('student.chat.create') }}"
...
<div class="grid gap-6 sm:grid-cols-1 lg:grid-cols-2">
    ...
    <div class="group relative overflow-hidden bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div class="p-6">
            ...
            <div class="mt-4">
                <a href="{{ route('student.chat.show', $chat->id) }}"
                ...
                {{-- Botón de eliminar --}}
                <form action="{{ route('student.chat.delete', $chat->id) }}" method="POST" class="mt-2 text-right"
